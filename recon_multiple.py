...
def main():
    ...
    # ── Criando a Tupla de Escopo para Validação ──────────────────────────────
    # Isso garante que só salvaremos subdomínios que terminem com os domínios da lista
    ...
    # 1. Subfinder (Aceita lista via -dL)
    ...
    # 2. Assetfinder (Não aceita lista, usamos xargs para ler linha por linha)
    ...
    # 3. Findomain (Aceita lista via -f)
    ...
    # 6. Httpx (Piping o arquivo limpo)
